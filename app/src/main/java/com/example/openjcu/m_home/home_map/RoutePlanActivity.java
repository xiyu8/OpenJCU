...
import com.example.openjcu.m_home.home_map.other.RouteLineAdapter;
import com.example.openjcu.m_home.home_map.overlayutil.BikingRouteOverlay;
import com.example.openjcu.m_home.home_map.overlayutil.DrivingRouteOverlay;
import com.example.openjcu.m_home.home_map.overlayutil.MassTransitRouteOverlay;
import com.example.openjcu.m_home.home_map.overlayutil.OverlayManager;
import com.example.openjcu.m_home.home_map.overlayutil.TransitRouteOverlay;
import com.example.openjcu.m_home.home_map.overlayutil.WalkingRouteOverlay;
...
import static com.example.openjcu.tool.Localtion.initPosition;
import static com.example.openjcu.tool.Localtion.mm;
...
//        PlanNode enNode = PlanNode.withCityNameAndPlaceName("北京", endNodeStr);
        ...
        Log.e("OpenJCU", "222222222222222222222"+targetadd+"_"+targetadd+"____"+ll+"_"+ll);
//        while ((""+ll.latitude).equals("4.9E-324")){}

        LatLng currentAdd = new LatLng(30.729712, 103.956601);
        initPosition(RoutePlanActivity.this);
        LatLng currentAdd1=mm(RoutePlanActivity.this);
        PlanNode stNode = PlanNode.withLocation(ll); //设置起点、终点可用经纬度！经纬度！！经纬度！！！
        PlanNode enNode = PlanNode.withLocation(targetadd);
...
//        if (v.getId
    ...
    // 响应DLg中的List item 点击 //界面上的跨城交通
    interface OnItemInDlgClickListener {
        public void onItemClick(int position);
    }

    // 供路线选择的Dialog   //界面上的跨城交通
